...
<div class="layui-form" lay-filter="layui-btn-normal" id="layui-btn-normal" style="padding: 20px 0 0 0;">
	<div class="layui-form-item" style="text-align: center">
		...
		<div class="layui-input-inline">
			<input type="text" name="payment_name" id="payment_name" lay-verify="required"
	...
	<div class="layui-form-item layui-form-text">
		...
		<div class="layui-input-inline">
			<input type="text" name="payment_type" id="payment_type" lay-verify="required" placeholder="请输入付款类型"
			       autocomplete="off" class="layui-input">
		</div>
	</div>
	...
	<div class="layui-form-item layui-form-text">
		...
		<div class="layui-input-inline">
			<input type="text" name="payment_remarks" id="payment_remarks" lay-verify="required" placeholder="备注"
			       autocomplete="off" class="layui-input">
		</div>
	</div>
