...
<div class="layui-form" lay-filter="layui-btn-normal" id="layui-btn-normal" style="padding: 20px 0 0 0;">
	<div class="layui-form-item" style="text-align: center">
		...
		<div class="layui-input-inline">
			<input type="text" name="receivables_name" id="receivables_name" lay-verify="required"
	...
	<div class="layui-form-item layui-form-text">
		...
		<div class="layui-input-inline">
			<input type="text" name="receivables_remarks" id="receivables_remarks" lay-verify="required" placeholder="备注"
			       autocomplete="off" class="layui-input">
		</div>
	</div>
