...
<div class="layui-form" lay-filter="layui-btn-normal" id="layui-btn-normal" style="padding: 20px 0 0 0;">
	<div class="layui-form-item" style="text-align: center">
		...
		<div class="layui-input-inline">
			<input type="text" name="safe_event_title" id="safe_event_title" lay-verify="required" placeholder="请输入用户名"
	...
	<div class="layui-form">
		<div class="layui-form-item">
			<div class="layui-inline">
				<label class="layui-form-label">发生时间:</label>
				<div class="layui-input-inline">
					<input type="hidden" style="visibility:hidden" class="layui-input" id="safe_event_date">
				</div>
			</div>
		</div>
	</div>
	...
	<div class="layui-form-item" style="text-align: center">
		...
		<div class="layui-input-inline">
			<input type="text" style="border:0px"  name="safe_event_recorder" lay-verify="safe_event_recorder" id="safe_event_recorder"
			        autocomplete="off" class="layui-input">
		</div>
	</div>
