...
<div class="layui-form" lay-filter="layui-btn-normal" id="layui-btn-normal" style="padding: 20px 0 0 0;">
	<div class="layui-form-item" style="text-align: center">
		...
		<div class="layui-input-inline">
			<input type="text" name="operation_matter" id="operation_matter" lay-verify="required" placeholder="请输入内容"
	...
	<div class="layui-form-item layui-form-text">
		...
		<div class="layui-input-inline">
			<input type="text" name="operation_person" id="operation_person" lay-verify="required" placeholder="请输入操作人"
			       autocomplete="off" class="layui-input">
		</div>
	</div>
