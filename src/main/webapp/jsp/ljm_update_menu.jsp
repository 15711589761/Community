				...
				<div class="col-md-10 column">
					<table class="table table-bordered">
						...
						<tr class="error">
							<td>菜单名称：</td>
							<td>
								<input class="form-control" id="update_menu"/>
							</td>
						</tr>
						<tr class="success">
							<td>菜单地址：</td>
							<td>
								<input class="form-control" id="update_menu_url"
								       name="visitorOrigin"/>
							</td>
						</tr>
						<tr>
							...
							<td style="height: 200%;" colspan="3">
								<div class="layui-input-inline">
									<select id="menu_ascription" name="menuPid" class="layui-input">
										<option value="">不修改</option>
										<option value="0">后台管理端</option>
										<option value="1">物业端</option>
									</select>
								</div>
							</td>
						</tr>
