...
//
//@Controller
//public class WsyPropertyCostsController
//{
//
//	//应用ID
...
//	private final String RETURN_URL = "http://localhost:8081/Community/successJsp";
//
//	@Resource
//	private Zk_BillService zk_billService;
//
//	@RequestMapping("/propertycostsJSP")
...
//	{
//		return new ModelAndView("wsy_propertycosts");
//	}
//
//	//生成订单界面
...
//	}
//	@RequestMapping("/successJsp.action")
//	@ResponseBody
...
//					owner=ownerBeans.get(i).getOwnerRoom();
//					System.out.println("房间号："+owner);
//					zk_billBean.setPayer(owner);
//				}
//			}
//			zk_billBean.setDetails("物业缴付");
