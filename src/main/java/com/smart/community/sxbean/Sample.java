...
public class Sample {
	//设置APPID/AK/SK
	public static final String APP_ID = "18089761";
	public static final String API_KEY = "mD2GEMPOmTzQC07CV8fnDs0W";
	public static final String SECRET_KEY = "psKUgHDwZ07SRQYYUmPFZNOV8dDjKXSl";
...
//		System.out.println(res.toString(2));
	...
	public static String base64() {
		...
		//读取图片字节数组
		try {
			in = new FileInputStream("D:\\imageTest\\test2.jpg");
